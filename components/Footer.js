  ...
  <footer className="bg-blue-skies-900 text-white py-8 px-4 xl:px-0">
    <div className="container mx-auto text-center md:items-center md:justify-between md:flex">
      ...
      <div className="contact flex items-center justify-center">
        {/* <i className="icon-envelope mx-2"></i> <a href="mailto:joseph@josephmasongsong.com">joseph@josephmasongsong.com</a> */}
        <i className="icon-social-github mx-2"></i> <a href="https://github.com/josephmasongsong">github.com/josephmasongsong</a>
      </div>
    </div>
  </footer>
